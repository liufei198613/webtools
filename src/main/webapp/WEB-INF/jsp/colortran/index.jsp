...
<div class="row">
    <div class="row">
        <form action="" method="POST">
            ...
            <div class="col-xs-4">
                <input type="text" class="form-control" placeholder="请在这里输入RGB，或者类如#00000的十六进制"
                       id="inputColor" name="inputColor" value="" onKeyUp="tranJColor();">
            </div>
            <div class="col-xs-4">
                <button onClick="tranJColor()" class="btn btn-success"/>
                智能转换</button>
            </div>
        </form>
    </div>
    ...
    <table class="table" style="height:200px;">
        <tr>
            <td id="theColorYouInputShowHere" width="20px;" bgcolor="<?php echo $hex; ?>"
